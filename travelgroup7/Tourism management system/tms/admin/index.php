        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $row) {
                if ($row->Status == "1") {
                    ...
                    echo "<script>
          alert('Tài khoản của bạn đã bị vô hiệu hóa tiếp cận quản trị viên');document.location ='index.php';
          </script>";
                }
            }
        }
...
<head>
    ...
    <title>TMS Admin - Đăng nhập</title>
                                ...
                                <div class="login-form">
                                    ...
                                    <form role="form" id="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="form-group mb-3">
                                            <input type="text" class="form-control form-control-lg" name="username" id="exampleInputEmail1" placeholder="Tên tài khoản" required>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            <button name="login" class="btn btn-primary btn-block">Đăng nhập</button>
                                        </div>
