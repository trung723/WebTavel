...
if (strlen($_SESSION['odmsaid']==0)) 
{
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query->execute();
    $_SESSION['msg']="Hình ảnh hồ sơ được cập nhật thành công !!";
  }
  ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Admin - Cập nhật hồ sơ người dùng</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ảnh người dùng</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Cập nhật ảnh người dùng</li>
                        </ol>
                    </div>
                   ...
                   {?>
                                              ...
                                              foreach($results as $row)
                                  {
                                    ?>
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Tên</label>
                                            <div class="col-6">
                            ...
                            { 
                              ?>
                                                <img src="profileimages/<?php  echo $row->Photo;?>" width="170"
                                                    height="150">
                                                <?php
                            } ?>
                                            </div>
