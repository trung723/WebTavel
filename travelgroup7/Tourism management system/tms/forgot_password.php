         ...
         if($error)
          ...
          {?>
                        ...
                        <p style="width: 350px;">
                            ...
                            <b>Địa chỉ Email:</b> <input type="email" name="email" class="form-control" id="email"
                                placeholder="Id email đăng ký" required="">
                        </p>

                        <p style="width: 350px;">

                            <b>Số điện thoại:</b> <input type="text" name="mobile" class="form-control" id="mobile"
                                placeholder="Số điện thoại đăng ký" required="">
                        </p>
