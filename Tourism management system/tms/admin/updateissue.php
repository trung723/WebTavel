...
if(isset($_POST['submit2']))
{
	...
	$query -> execute();
	$msg="Ghi chú Đã cập nhật thành công";
}
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr height="50">
                    <td colspan="2" class="fontkink2" style="padding-left:0px;">
                        <div class="fontpink2"> <b>Cập nhật nhận xét!</b></div>
                    </td>

                </tr>
                <tr>
                    <td colspan="2"> <?php $error = "";
                        if($error){?><div class="errorWrap">
                            <strong>Lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } 
