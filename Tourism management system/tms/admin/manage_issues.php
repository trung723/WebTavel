...
<head>
    ...
    <title>Admin - Quản lý vấn đề</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Vấn đề</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Quản lý vấn đề</li>
                        </ol>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Quản lý vấn đề</h6>
                                    <?php if($error){?>
                                    <div class="errorWrap">
                                            ...
                                            foreach($results as $result)
                                            {
                                              ?>
                                                ...
                                                <td><a href="javascript:void(0);"
                                                        onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');">Xem
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
