...
<head>
  ...
  <title>Quản trị - quản lý tư vấn</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Hỏi đáp</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Quản lý yêu cầu</h6>
                  <?php if($error){?>
                    <div class="errorWrap">
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {       
                          ...
                          <tr>
                            ...
                            {
                              ?>
                              <td><a href="manage_enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Chưa giải quyết</a>
                              </td>
                              <?php 
                            } ?>
