                                    ...
                                    <table class="table align-items-center table-flush ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="d-none d-sm-table-cell text-center">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                          ...
                          ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <button class="btn btn-primary btn-sm edit_data"
                                                        id="<?php echo  ($row->id); ?>" title="bấm vào để chỉnh sửa">Thay đổi quyền</button>
                                                </td>
                                            </tr>
                                            <?php $cnt=$cnt+1;
                       }
