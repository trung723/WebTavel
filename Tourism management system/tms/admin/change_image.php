...
<head>
    ...
    <title>Quản trị viên - Thay đổi hình ảnh tour</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid" id="container-wrapper">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Hình ảnh tour</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Thay đổi hình ảnh</li>
                    </ol>
                </div>
                                    ...
                                    if($query->rowCount() > 0)
                                    {
                                        foreach($results as $result)
                                        {
                                            ...
                                            <div class="form-group">
                                                <label for="focusedinput" class="col-sm-2 control-label"> Hình ảnh Tour </label>
                                                <div class="col-sm-8">
