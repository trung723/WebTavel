...
<head>
  ...
  <title>Quản trị viên - Cập nhật hồ sơ người dùng</title>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Cập nhật hồ sơ người dùng</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Cập nhật hồ sơ người dùng</h6>
                </div>
                <div class="card-body">
                  <form method="post">
                    <?php
                        ...
                        <div class="container rounded bg-white mt-5">
                          <div class="row">
                            <div class="col-md-4 border-right">
                              ...
                              <div class="mt-3">
                                <a href="update_userimage.php?id=<?php echo $adminid;?>">Chỉnh sửa hình ảnh</a>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-8">
