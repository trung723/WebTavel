        ...
        <form name="chngpwd" method="post" onSubmit="return valid();">
         ...
         if($error)
          ...
          <p style="width: 350px;">
            ...
            <b>Email ID</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Id email đăng ký" required="">
          </p> 

          <p style="width: 350px;">

            <b>Số điện thoại</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Số diện thoại đăng ký" required="">
          </p> 
