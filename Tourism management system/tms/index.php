...
<section id="packages" class="secPad">
    <div class="container">
        <div class="heading text-center">
            ...
            <!-- Heading -->
            <h2>Top Các Tour Nổi Bật</h2>

        </div>
        <div class="">

            <?php $sql = "SELECT * FROM tbltourpackages tp JOIN tblbooking b ON tp.PackageId = b.PackageId GROUP BY tp.PackageId ORDER BY COUNT(b.PackageId) DESC LIMIT 3";
...
<section id="packages" class="secPad">
    <div class="container">
        <div class="heading text-center">
            ...
            <!-- Heading -->
            <h2>Danh sách các gói nổi tiếng </h2>
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio-desc align-center">
                                    <div class="folio-Get It!">
                                        <a href="images/portfolio/p10.jpg" class="fancybox">
